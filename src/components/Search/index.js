  ...
  const ListItem = ({ title, url, xIndex, yIndex }) => {
    ...
    return (
      <Link
        ...
        className={cx(
          style.Search__link,
          selected && active ? style['Search__link--focused'] : ''
        )}
      >
        {title}
        ...
        >
          <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">
            <g fill="none" fillRule="evenodd">
              ...
              <path
                d="M15.778 1.636L9.415 7.999l6.363 6.365-1.414 1.414-6.363-6.364-6.365 6.364-1.414-1.414 6.364-6.365L.222 1.636 1.636.222l6.365 6.363L14.364.222l1.414 1.414z"
                fill="#747578"
              />
            </g>
          </svg>
        ...
        <div className={style.Search} ref={containerRef}>
          <ArrowNavigation>
            ...
            <div
              className={cx(
                style.Search__list,
                results.length > 0 ? style['Search__list--isVisible'] : null
              )}
            >
              <ResultList />
            </div>
