    ...
    <Link className={cx(style.Card, (grid ? '' :  style['Card--list'] ))} to={`/${url}`} >
      <article className={cx(!grid ? style.Card__wrapper : '' )}>
        ...
        <div className={style.Card__body}> 
          ...
          {lang && !grid && <svg className={style.Card__flag}  xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"><defs><path id="a11" d="M0 0h33.621v25H0z"/></defs><g fill="none" fillRule="evenodd"><path d="M0 0h33.93v25H0z" fill="#006AA7" fillRule="nonzero"/><mask id="b11" fill="#fff"><use xlinkHref="#a11"/></mask><path fill="#FECC00" fillRule="nonzero" mask="url(#b11)" d="M8.405 10.417H0v4.166h8.405V25h4.203V14.583h21.013v-4.166H12.608V0H8.405z"/></g></svg>}
