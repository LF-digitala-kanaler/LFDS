...
var Menu = function Menu(_ref) {
  ...
  var navigationStructure = lodash__WEBPACK_IMPORTED_MODULE_12___default()(navigationItems.items).chain().groupBy('node.frontmatter.category').pull(navigationStructure, 'NoCategory').map(function (value, key) {
    return {
      parentLink: key,
      childLink: value
    };
...
//# sourceMappingURL=cms.b93624a785b65bcdb7d5.hot-update.js.map