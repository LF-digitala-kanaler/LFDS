...
var Menu = function Menu(_ref) {
  ...
  var navigationStructure = lodash__WEBPACK_IMPORTED_MODULE_12___default()(navigationItems.items).chain().groupBy('node.frontmatter.category').pull('node.frontmatter.category', 'NoCategory').map(function (value, key) {
    return {
      parentLink: key,
      childLink: value
    };
...
//# sourceMappingURL=cms.d3a912840955c1ea38c5.hot-update.js.map