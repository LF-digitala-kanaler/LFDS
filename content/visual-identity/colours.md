    ...
    <article class="Colors__item Colors__item--complimentary">
     ...
     <article class="Colors__item Colors__item--complimentary">
      <div class="Colors__complimentary" style="border-color: #6B7070">
        ...
        <p class="Colors__text"><span>HEX</span> #6B7070</p>
...
<div class="Colors">
    ...
    <article class="Colors__item Colors__item--special">
      <div class="Colors__special" style="border-color: #E5FFF0">
        ...
        <p class="Colors__text"><span>HEX</span> #E5FFF0</p>
    ...
    <article class="Colors__item Colors__item--special">
      <div class="Colors__special" style="border-color: #FFDFE0">
        <div class="Colors__background" style="background-color: #FFDFE0"></div>
        <h3 class="Colors__title">Danger</h3>
        <p class="Colors__text"><span>RGB</span> 255 223 224</p>
        <p class="Colors__text"><span>HEX</span> #FFDFE0</p>
    ...
    <article class="Colors__item Colors__item--special">
      <div class="Colors__special" style="border-color: #005AA0">
        ...
        <h3 class="Colors__title">Info text</h3>
        <p class="Colors__text"><span>RGB</span> 0 90 160</p>
        <p class="Colors__text"><span>HEX</span> #005AA0</p>
        <p class="Colors__text"><span>CSS</span> --color-info-text</p>
      </div>
    </article>
    <article class="Colors__item Colors__item--special">
      <div class="Colors__special" style="border-color: #1B5E20">
        <div class="Colors__background" style="background-color: #1B5E20"></div>
        <h3 class="Colors__title">Success text</h3>
        <p class="Colors__text"><span>RGB</span> 27 94 32</p>
        <p class="Colors__text"><span>HEX</span> #1B5E20</p>
        <p class="Colors__text"><span>CSS</span> --color-success-text</p>
      </div>
    </article>
    <article class="Colors__item Colors__item--special">
      <div class="Colors__special" style="border-color: #996006">
        <div class="Colors__background" style="background-color: #996006"></div>
        <h3 class="Colors__title">Warning text</h3>
        <p class="Colors__text"><span>RGB</span> 153 96 6</p>
        <p class="Colors__text"><span>HEX</span> #996006</p>
        <p class="Colors__text"><span>CSS</span> --color-warning-text</p>
      </div>
    </article>
    <article class="Colors__item Colors__item--special">
      <div class="Colors__special" style="border-color: #AD1015">
        <div class="Colors__background" style="background-color: #AD1015"></div>
        <h3 class="Colors__title">Danger text</h3>
        <p class="Colors__text"><span>RGB</span> 173 16 21</p>
        <p class="Colors__text"><span>HEX</span> #AD1015</p>
        <p class="Colors__text"><span>CSS</span> --color-danger-text</p>
      </div>
    </article>
</div>
...
<div class="Colors">
    <article class="Colors__item Colors__item--special">
      <div class="Colors__special" style="border-color: #515151">
        ...
        <h3 class="Colors__title">Risk default</h3>
    ...
    <article class="Colors__item Colors__item--special">
      <div class="Colors__special" style="border-color: #2A7FD4">
        ...
        <h3 class="Colors__title">Risk #1</h3>
    ...
    <article class="Colors__item Colors__item--special">
      <div class="Colors__special" style="border-color: #389FB9">
        ...
        <h3 class="Colors__title">Risk #2</h3>
     ...
     <article class="Colors__item Colors__item--special">
      <div class="Colors__special" style="border-color: #8DBA84">
        ...
        <h3 class="Colors__title">Risk #3</h3>
    ...
    <article class="Colors__item Colors__item--special">
      <div class="Colors__special" style="border-color: #B8BE34">
        ...
        <h3 class="Colors__title">Risk #4</h3>
     ...
     <article class="Colors__item Colors__item--special">
      <div class="Colors__special" style="border-color: #FDB514">
        ...
        <h3 class="Colors__title">Risk #5</h3>
    ...
    <article class="Colors__item Colors__item--special">
      <div class="Colors__special" style="border-color: #ED7721">
        ...
        <h3 class="Colors__title">Risk #6</h3>
    ...
    <article class="Colors__item Colors__item--special">
      <div class="Colors__special" style="border-color: #CE161D">
        ...
        <h3 class="Colors__title">Risk #7</h3>
